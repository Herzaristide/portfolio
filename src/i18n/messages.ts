...
export const messages = {
  [LOCALES.ENGLISH]: {
    ...
    about_me:
      "Welcome to my website ! Passionate by design, I espress my creativity through web development.",
    about_studies:
      "With an engineering degree from ISEN, my studies and experience enable me to understand and solve the problems facing companies.",
    about_projects:
      "My academic background and my interest in web development have led me to work on a number of projects detailed in the project section.",
    ...
    astek_desc:
      "Astek is a digital services company (ESN) specializing in technology consulting and innovation.",
    ...
    astek_job_desc:
      "Deployment and maintenance of GED solution and JIRA project configuration.",

    orange_job: "Data engineer",
    orange_desc:
      "Orange is a French telecommunications company that offers mobile, internet, and television services.",
  ...
  [LOCALES.FRENCH]: {
    home_job: "Dévelopeur Full Stack",
    ...
    about_me:
      "Bienvenue sur mon site ! Passionné par le design, j'exprime ma créativité à travers le développement web.",
    about_studies:
      "Diplomée ingénieur de l'ISEN, mes études et éxperiences me permettent de comprendres et résoudre les problèmatiques qui s'impose au entreprise.",
    about_projects:
      "Mon parcours scholaire ainsi que mon appétence pour le dévelopement web, m'on amené a travailler sur quelques projets détaillées dans la section projet.",
    about_discover:
      "N'hésitez pas à me découvrir ou me contacter pour de plus amples informations !",
    ...
    astek_desc:
      "Astek est une entreprise de services du numérique (ESN) spécialisée dans le conseil en technologies et l'innovation.",
    ...
    astek_job_desc:
      "Déploiement et maintien de solution GED et configuration de projet JIRA.",

    orange_job: "Ingénieur de données",
    orange_desc:
      "Orange est une entreprise de télécommunications française qui propose des services de téléphonie mobile, d'internet et de télévision.",
